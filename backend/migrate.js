...
const FILES = ['schema.sql', 'migrate.sql', 'migrate2.sql', 'migrate3.sql', 'migrate4.sql', 'migrate5.sql', 'migrate6.sql', 'migrate7.sql', 'migrate8.sql', 'migrate9.sql', 'migrate10.sql'];
