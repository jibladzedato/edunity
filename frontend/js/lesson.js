...
function renderStepContent(step) {
    ...
    if (step.type === 'video') {
        ...
        return `<div class="lesson-video"><video src="${esc(mediaUrl(c.playUrl || c.url))}" controls controlsList="nodownload noplaybackrate" disablePictureInPicture oncontextmenu="return false" preload="metadata"></video></div>`;
    }
