...
async function load() {
    const cont = document.querySelector('.kursebi-container');
    cont.innerHTML = EdunityUI.skeleton(3, 'kursi-card skel-card');
    document.querySelector('.leqtorebis-fotoebi').innerHTML = EdunityUI.skeleton(4, 'leqtori-card skel-leqtori');
    try {
